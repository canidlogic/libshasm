 ...
 * test_input.c
 * 
 * Testing module for the input filter chain (shasm_input).
 * 
 * See the documentation of the main() function for a description of how
 * this testing program works.
 * 
 * This must be compiled with the shasm_input module.  Sample build
 * line:
 * 
 *   cc -o test_input test_input.c shasm_input.c
 */
 ...
 * through the Shastina input filters, and writes the filtered results
 * to standard output.
 * 
